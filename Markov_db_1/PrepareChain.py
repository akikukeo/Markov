...
class PrepareChain(object):
    ...
    def __init__(self, text):
        ...
        # 形態素解析用タガー
        # self.tagger = MeCab.Tagger('-r /etc/mecabrc -Ochasen')
        self.tagger = MeCab.Tagger('-r /etc/mecabrc -d /usr/lib/x86_64-linux-gnu/mecab/dic/mecab-ipadic-neologd -Ochasen')
